...
export default class LabeledInput extends PureComponent {
	render() {
		...
		return (
			<View style={[styles.border, {borderColor: Colors[this.props.color]}, styles.smallVerticalMargin, (this.props.addHorizontalMargin && styles.baseHorizontalMargin)]}>
				<View style={[styles.row, styles.customHeight, styles.alignItemsCenter]}>
					{icon}
